...
@interface DXGetActivityItemModel : NSObject
...
@property (nonatomic, copy) NSString *L_START_TIME;
...
@property (nonatomic, copy) NSString *L_END_TIME;

@property (nonatomic, copy) NSString *L_STATUS;

@property (nonatomic, copy) NSString *L_PATH;
